...
#define MyAppURL "https://github.com/Okohedeki/Nexus"
...
Name: "startupicon"; Description: "Start Nexus when Windows starts"; GroupDescription: "Startup:"
...
[Run]
Filename: "{app}\{#MyAppExeName}"; Description: "Launch Nexus"; Flags: nowait postinstall skipifsilent
